        ...
        <View style={styles.upperContainer}>
          <View style={styles.upperTopContainer}>
            ...
            <View style={styles.textContainer}>
              <Text style={styles.nameText}>Marko Marković</Text>
              <View style={styles.locationContainer}>
                ...
                />
                <Text style={styles.locationText}>Banja Luka</Text>
              </View>
        ...
        <View style={styles.lowerContainer}>
          ...
          <View
            ...
            <View style={{flexDirection: 'row', justifyContent: 'center'}}>
              <Text style={{fontSize: 28}}>120</Text>
              <Image
          ...
          <View style={{width: '100%', marginLeft: 60, marginTop: 5}}>
            ...
            <View style={{flexDirection: 'row', marginTop: 10}}>
              ...
              />
              <Text style={{fontSize: 18, marginLeft: 5}}>Volontiranje</Text>
            </View>
            <View style={{flexDirection: 'row', marginTop: 10}}>
              <View
                style={{
